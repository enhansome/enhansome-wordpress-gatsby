# Awesome wordpress gatsby with stars
...
* [WPGraphQL](https://github.com/wp-graphql/wp-graphql) ⭐ 3,789 | 🐛 113 | 🌐 PHP | 📅 2026-09-21 - [Documentation](https://docs.wpgraphql.com/) - WPGraphQL brings the power of GraphQL to your WordPress site.
...
* [WPGraphQL Offset Pagination](https://github.com/darylldoyle/wp-graphql-offset-pagination) ⭐ 17 | 🐛 2 | 🌐 PHP | 📅 2020-01-28 - This FREE plugin from @enshrined adds basic offset pagination as opposed to the standard Cursor based pagination that ships with WPGraphQL.

***

**Extensions for that use other plugins with WPGraphQL**

* [WPGraphQL for WooCommerce](https://github.com/wp-graphql/wp-graphql-woocommerce) ⭐ 710 | 🐛 19 | 🌐 PHP | 📅 2026-06-30 - This FREE plugin exposes WooCommerce data to WPGraphQL allowing you to interact with your store’s data via GraphQL Queries and mutations.
...
* [WPGraphQL for SEOPress](https://github.com/ashhitch/wp-graphql-yoast-seo) ⭐ 231 | 🐛 25 | 🌐 PHP | 📅 2026-09-21 - This FREE plugin from @moon\_meister exposes data managed by SEOPress to the WPGraphQL Schema, allowing for SEO data to be used in your headless applications.
* [WPGraphQl Yoast SEO Plugin](https://github.com/ashhitch/wp-graphql-yoast-seo) ⭐ 231 | 🐛 25 | 🌐 PHP | 📅 2026-09-21 - Exposes Yoast SEO data to the WPGraphQL Plugin.
* [WPGraphQL for Gravity Forms](https://github.com/harness-software/wp-graphql-gravity-forms) ⭐ 176 | 🐛 51 | 🌐 PHP | 📅 2026-09-19 - This FREE plugin from @KellenMace of @harness\_up exposes @gravityforms data to WPGraphQL, allowing you to query for forms, fields, entries, and more.
...
* [WPGraphQL Gutenberg ACF](https://github.com/pristas-peter/wp-graphql-gutenberg-acf) ⭐ 61 | 🐛 15 | 🌐 PHP | 📅 2023-04-27 - Exposes ACF blocks through GraphQL
* [WPGraphQL Tax Query](https://github.com/wp-graphql/wp-graphql-tax-query) ⭐ 55 | 🐛 19 | 🌐 PHP | 📅 2022-11-08 - Adds Tax\_Query support to the WPGraphQL Plugin for postObject query args (WP\_Query).
* [WPGraphQL WPML](https://github.com/rburgst/wp-graphql-wpml) ⭐ 51 | 🐛 16 | 🌐 PHP | 📅 2023-03-22 - This FREE plugin from @rburgst extends the WPGraphQL schema with language data from the WPML plugin. In addition it turns off WPML default filters in order to be able to iterate over all posts regardless of language.
* [WPGraphQL for BuddyPress](https://github.com/wp-graphql/wp-graphql-buddypress) ⭐ 42 | 🐛 10 | 🌐 PHP | 📅 2025-12-13 - This FREE plugin from @RenatoNascAlves exposes BuddyPress data to WPGraphQL.
* [WPGraphQL for FacetWP](https://github.com/hsimah-services/wp-graphql-facetwp) ⭐ 35 | 🐛 5 | 🌐 PHP | 📅 2025-06-07 - This FREE plugin from @hsimah exposes filters on WPGraphQL queries to allow for faceted search with FacetWP.
* [WPGraphQL for Metabox](https://github.com/hsimah-services/wp-graphql-metabox) ⭐ 28 | 🐛 8 | 🌐 PHP | 📅 2025-01-10 - This FREE plugin from @hsimah exposes fields registered using the popular <http://MetaBox.io> to the WPGraphQL Schema.
* [WPGraphQL for Carbon Fields](https://github.com/matepaiva/wp-graphql-crb) ⭐ 24 | 🐛 2 | 🌐 PHP | 📅 2024-02-18 - This FREE plugin from @matepaiva exposes fields registered using Carbon Fields to the WPGraphQL Schema.
* [WPGraphQL Enable All Post Types (DalkMania)](https://github.com/DalkMania/wp-graphql-cpt) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2023-05-23 - This FREE plugin from @DalkMania automatically adds ALL registered post types to the WPGraphQL Schema.
* [QL Search](https://github.com/funkhaus/ql-search) ⚠️ Archived - An extension that integrates SearchWP into WPGraphQL.
* [WPGraphQL MB (MetaBox)](https://github.com/DalkMania/wp-graphql-mb) ⭐ 13 | 🐛 0 | 🌐 PHP | 📅 2022-05-10 - This FREE plugin from @DalkMania adds all registered metaboxes using [metabox.io](https://metabox.io/) to the WPGraphQL Schema.
* [WPGraphQL MetaBox Relationships](https://github.com/hsimah-services/wp-graphql-mb-relationships) ⭐ 11 | 🐛 3 | 🌐 PHP | 📅 2020-07-25 - This FREE plugin from @hsimah adds support for the [metabox.io](https://metabox.io/) Relationships field to WPGraphQL (when also using his wp-graphql-metabox plugin).
* [WPGraphQL for Ninja Forms](https://github.com/toriphes/wp-graphql-ninja-forms) ⭐ 11 | 🐛 7 | 🌐 PHP | 📅 2021-09-24 - This free plugin exposes forms created by the Ninja Forms plugin to the WPGraphQL Schema and allows for the forms to be submitted via GraphQL Mutations.
* [WPGraphQL Enable All Post Types (TylerBarnes)](https://github.com/TylerBarnes/wp-graphql-enable-all-post-types) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2020-07-08 - This FREE plugin from @tylbar automatically adds ALL registered post types to the WPGraphQL Schema.
* [WPGraphQL Google Schema](https://github.com/izzygld/wp-graphql-google-schema) ⭐ 9 | 🐛 0 | 🌐 Vue | 📅 2020-02-18 - This FREE plugin from @izzygld261 adds Google Schema support to WPGraphQL.
* [WPGraphQL for Posts 2 Posts](https://github.com/harness-software/wp-graphql-posts-to-posts) ⭐ 9 | 🐛 4 | 🌐 PHP | 📅 2023-03-28 - This FREE plugin from @KellenMace of @harness\_up automatically creates GraphQL connections for all of your Posts 2 Posts connections.
* [WPGraphQL Polls](https://github.com/andrenoberto/wp-graphql-polls) ⭐ 4 | 🐛 1 | 🌐 PHP | 📅 2019-09-03 - This FREE plugin from @andrenosouza allows you to interact with data from the WP-Polls plugin via GraphQL Queries and Mutations.
...
* [Gatsby + Headless WordPress + Netlify Starter](https://github.com/justinwhall/gatsby-wordpress-netlify-starter) ⭐ 212 | 🐛 34 | 🌐 JavaScript | 📅 2023-01-11 - A Gatsby + WordPress starter for continuous deployment to Netlify.
* [Gatsby Starter - WordPress Twenty Twenty](https://github.com/henrikwirth/gatsby-starter-wordpress-twenty-twenty) ⭐ 144 | 🐛 23 | 🌐 CSS | 📅 2022-12-13 - A port of the WordPress Twenty Twenty theme to Gatsby using the new gatsby-source-wordpress\@v4.
* [Gatsby + WPGraphQL Blog Example](https://github.com/wp-graphql/gatsby-wpgraphql-blog-example) ⚠️ Archived - Demo showing how to use WPGraphQL as the source for Gatsby Sites.
* [Gatsby WordPress Starter Advanced](https://github.com/henrikwirth/gatsby-starter-wordpress-advanced) ⚠️ Archived - An advanced Gatsby + WordPress starter, that is built along a tutorial series and works with ACF flexible content fields to create content blocks/layouts.
* [Gatsby Starter Blog](https://github.com/zeevo/gatsby-starter-wordpress-blog) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2023-06-10 - Blog starter with enough features to be production ready out of the box.

## Themes

List of gatsby-themes that work with WordPress as a source, which you can use in your Gatsby setup.

* [Twenty Nineteen Gatsby Theme](https://github.com/zgordon/twentynineteen-gatsby-theme) ⭐ 65 | 🐛 32 | 🌐 CSS | 📅 2023-01-03 - A port of the Twenty Nineteen WordPress Theme over to Gatsby.
* [Gatsby WordPress Publisher Theme
  ](https://github.com/staticfuse/gatsby-theme-publisher) ⭐ 31 | 🐛 36 | 🌐 JavaScript | 📅 2023-01-04 - The Gatsby Publisher Theme allows you to create a headless (or decoupled) WordPress site. This theme will display all of your pages and posts in a static front-end built on React and Gatsby.
