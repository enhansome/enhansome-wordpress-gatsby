...
* [WPGraphQL](https://github.com/wp-graphql/wp-graphql) ⭐ 3,790 | 🐛 81 | 🌐 PHP | 📅 2026-08-12 - [Documentation](https://docs.wpgraphql.com/) - WPGraphQL brings the power of GraphQL to your WordPress site.
...
* [WPGraphQL for WooCommerce](https://github.com/wp-graphql/wp-graphql-woocommerce) ⭐ 704 | 🐛 19 | 🌐 PHP | 📅 2026-06-30 - This FREE plugin exposes WooCommerce data to WPGraphQL allowing you to interact with your store’s data via GraphQL Queries and mutations.
...
* [WPGraphQL for Gravity Forms](https://github.com/harness-software/wp-graphql-gravity-forms) ⭐ 173 | 🐛 41 | 🌐 PHP | 📅 2026-08-10 - This FREE plugin from @KellenMace of @harness\_up exposes @gravityforms data to WPGraphQL, allowing you to query for forms, fields, entries, and more.
* [WPGraphQL Polylang Extension](https://github.com/valu-digital/wp-graphql-polylang) ⭐ 147 | 🐛 50 | 🌐 PHP | 📅 2025-05-06 - Extends WPGraphQL schema with language data from the Polylang plugin.
