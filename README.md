...
* [WPGraphQL](https://github.com/wp-graphql/wp-graphql) ⭐ 3,791 | 🐛 79 | 🌐 PHP | 📅 2026-09-01 - [Documentation](https://docs.wpgraphql.com/) - WPGraphQL brings the power of GraphQL to your WordPress site.
...
* [WPGraphQL for Gravity Forms](https://github.com/harness-software/wp-graphql-gravity-forms) ⭐ 175 | 🐛 44 | 🌐 PHP | 📅 2026-09-01 - This FREE plugin from @KellenMace of @harness\_up exposes @gravityforms data to WPGraphQL, allowing you to query for forms, fields, entries, and more.
